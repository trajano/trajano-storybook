<template>
  ...
  >
    ...
    <p>I chose PT Sans the default text font.</p>
    <p>
    ...
    <div class="text-xxs">
      text xxs. This is targetted as 10px font for the mobile screen and has limited use.
    </div>
    <p>
...
const { fontFamily } = withDefaults(
  defineProps<{ fontFamily?: 'lato' | 'lexend' | 'ibm-plex-sans' | 'roboto' }>(),
  {}
)
</script>
